...
export default function ComponentsPage() {
    ...
    const navItems = [
        ...
        { id: 'toggle', label: t('components.toggleExample.title') },
        { id: 'card', label: t('components.sections.card') },
        { id: 'stats', label: t('components.sections.stats') },
        { id: 'statistic', label: t('components.statisticExample.title') },
        { id: 'badge', label: t('components.badgeExample.title') },
        { id: 'status-badge', label: t('components.statusBadgeExample.title') },
        { id: 'avatar', label: t('components.sections.avatar') },
        { id: 'table', label: t('components.sections.table') },
        { id: 'carousel', label: t('components.carouselExample.title') },
        { id: 'tree', label: t('components.treeExample.title') },
        { id: 'descriptions', label: t('components.descriptionsExample.title') },
        { id: 'timeline', label: t('components.timelineExample.title') },
        ...
        { id: 'context-menu', label: t('components.contextMenuExample.title') },
        { id: 'breadcrumb', label: t('components.breadcrumbExample.title') },
        ...
        { id: 'command', label: t('components.commandExample.title') },
        { id: 'collapsible', label: t('components.collapsibleExample.title') },
        { id: 'steps', label: t('components.stepsExample.title') },
        { id: 'menubar', label: t('components.menubarExample.title') },
        { id: 'resizable', label: t('components.resizableExample.title') },
